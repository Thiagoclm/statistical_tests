...
print(np.median(rvs3))
print(Stats.multi_samp_kruskal(rvs1,rvs2,rvs3))

# pvalue=0.53709
# Since the pvalue is greater than 0.05, the null hypothesis is not rejected, hence 
# the three samples have the same median within the confidence interval. 
# This can be confirmed by the numbers above
